  ...
  {:else if offer}
    ...
    <div id="offer">
      ...
      <p>
        Bounty for this job:
        <b>
          {Object.keys(offer.bounty).reduce((acc, u) => acc + offer.bounty[u], 0) / 1000}sat
        </b>
      </p>
          ...
          <div class="bar">
            {#each Object.keys(offer.bounty).sort((a, b) => a - b) as acct, i}
              <div
                ...
                data-tooltip={`${acct in $kbaccounts ? $kbaccounts[acct] : acct}\n${offer.bounty[acct] / 1000}sat`}
                style={`width:${percentCount(offer.bounty[acct])}%;background:rgba(87, 85, 217, ${i === 0 ? 1 : (1 - i / 5).toFixed(2)})`}>
              ...
              <div class="completion">
                ...
                {#each Object.keys(offer.completions) as completer}
                  ...
                  <p>
                    ...
                    <br />
                    <small>
                      {new Date(offer.completions[completer].time * 1000).toGMTString()}
                    </small>
                  </p>
